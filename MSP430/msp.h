...
//
// hardware SPI
#define LCD_SPI_SEL portSel(LCD_SCLK_PORT)
#if defined G2955_ROBG || defined G2553_TI
#define LCD_SPI_SEL2 portSel2(LCD_SCLK_PORT)
#endif
//
#if defined G2553_TI
#define LCD_DISABLE_HARDWARE_SPI  LCD_SPI_SEL &= ~(LCD_SCLK_PIN + LCD_MOSI_PIN + LCD_MISO_PIN); LCD_SPI_SEL2 &= ~(LCD_SCLK_PIN + LCD_MOSI_PIN + LCD_MISO_PIN)
#define LCD_ENABLE_HARDWARE_SPI LCD_SPI_SEL |= LCD_SCLK_PIN + LCD_MOSI_PIN + LCD_MISO_PIN; LCD_SPI_SEL2 |= LCD_SCLK_PIN + LCD_MOSI_PIN + LCD_MISO_PIN
#else
#define LCD_DISABLE_HARDWARE_SPI  LCD_SPI_SEL &= ~(LCD_SCLK_PIN + LCD_MOSI_PIN + LCD_MISO_PIN)
#define LCD_ENABLE_HARDWARE_SPI LCD_SPI_SEL |= LCD_SCLK_PIN + LCD_MOSI_PIN + LCD_MISO_PIN
#endif
//
#endif /* MSP_H_ */
